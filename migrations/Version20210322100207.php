 ...
 */
final class Version20210322100207 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE participant_groupe (participant_id INT NOT NULL, groupe_id INT NOT NULL, INDEX IDX_B6C532A09D1C3019 (participant_id), INDEX IDX_B6C532A07A45358C (groupe_id), PRIMARY KEY(participant_id, groupe_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE participant_groupe DROP FOREIGN KEY FK_B6C532A07A45358C');
